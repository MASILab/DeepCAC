...
from step1_heartloc import export_data
from step1_heartloc import downsample_data
from step1_heartloc import input_data_prep
from step1_heartloc import run_inference
...
def run_process(conf_dict):
    ...
    raw_data_folder_name = conf_dict["io"]["raw_data_folder_name"]
    ...
    qc_curated_data_folder_name = conf_dict["io"]["qc_curated_data_folder_name"]
    resampled_data_folder_name = conf_dict["io"]["resampled_data_folder_name"]
    ...
    create_test_set = conf_dict["processing"]["create_test_set"]
    curated_size = conf_dict["processing"]["curated_size"]
    curated_spacing = conf_dict["processing"]["curated_spacing"]
    model_input_size = conf_dict["processing"]["model_input_size"]
    model_input_spacing = conf_dict["processing"]["model_input_spacing"]

    # model config
    # weights_file_name = conf_dict["model"]["weights_file_name"]
    down_steps = conf_dict["model"]["down_steps"]
    extended = conf_dict["model"]["extended"]
    ...
    export_data.export_data(raw_data_dir_path = raw_data_dir_path,
                            ...
                            input_scan_postfix = conf_dict['io']['input_scan_postfix']
                            )
